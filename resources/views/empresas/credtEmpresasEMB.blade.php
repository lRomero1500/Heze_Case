    ...
    <div class="contentFormulario3Colomnas" style="padding:0px!important;margin-bottom: 0.5em">
        ...
        <div class="contenedorDeCampos">
            ...
            <div class="campoCorto"><h5>Razón social</h5>
                <input id="nomb_Companias" name="nomb_Companias" type="text" value="" placeholder="" requerido="true"
                       style="">
            </div>
...
{{--            <div class="campoCorto"><h5>Logo</h5>
            ...
            <div class="campoCorto"><h5>Logo</h5>
                <input type="file" name="logo_companias" id="logo_companias" accept="image/*" style=" width: 0.1px; height: 0.1px;  opacity: 0;  overflow: hidden;  position: absolute;  z-index: -1;">
    ...
    overflow: hidden; vertical-align: top;"></span> <strong style=" height: 100%; color: #f1e5e6; background: #d3394c; display: inline-block;">
