<link href="JS/jqueryui/themes/base/jquery-ui.css"/>
...
<div class="contentFormulario3Colomnas" style="padding:0px!important;margin-bottom: 0.5em;width: 877px">
    ...
    <div class="contenedorDeCampos">
        <div class="campoCorto"><h5>Nombres</h5>
            <input type="text" value="" placeholder="" title="Ingrese nombres del colaborador" onkeypress="return validaTexto();">
        </div>
        <div class="campoCorto"><h5>Apellidos</h5>
            <input type="text" value="" placeholder="" title="Ingrese apellidos del colaborador" onkeypress="return validaTexto();" >
        </div>
